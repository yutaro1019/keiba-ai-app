...
| 用途 | 使用モデル |
|---|---|
| 通常予想・回収率重視 | `no_market_lambdarank_v3_g40_8_3_1` |
| 的中率重視 | `no_market_lambdarank_v3_g40_8_3_1` |
| Kelly AI | `no_market_lambdarank_v2` |
| 比較用 | `market` |
...
スクレイピングで取得したレースデータ、払戻、オッズは、netkeibaなど取得元サイトの利用規約に配慮してGitHubにはアップロードしません。

学習済みモデル、ログ、ローカルキャッシュも容量と再配布範囲の都合で公開しない前提です。
